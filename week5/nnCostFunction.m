...
Theta1 = reshape(nn_params(1:hidden_layer_size * (input_layer_size + 1)), ...
                 hidden_layer_size, (input_layer_size + 1)); % 25*401 (add Theta0 as bias)

Theta2 = reshape(nn_params((1 + (hidden_layer_size * (input_layer_size + 1))):end), ...
                 num_labels, (hidden_layer_size + 1)); % 10*26 (add Theta0 as bias)
...
% a1 = X
X = [ones(m,1) X]; % 5000*401 add theta0
z2 = Theta1 * X'; % (25*401)*(401*5000)
a2 = sigmoid(z2); % 25*5000

a2 = [ones(m,1) a2'];  % 26*5000 add theta0
z3 = Theta2 * a2'; % (10*26)*(26*5000)
h_theta = sigmoid(z3); %10*5000

y_new = zeros(num_labels, m); %10*5000 , y_new is a 10-dimensional vectors ie (1 0....0)
  for i = 1:m
  y_new(y(i),i)=1;
  end
